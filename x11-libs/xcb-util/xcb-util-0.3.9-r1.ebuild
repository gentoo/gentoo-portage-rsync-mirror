...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/xcb-util/xcb-util-0.3.9-r1.ebuild,v 1.1 2014/06/17 17:35:43 mgorny Exp $
...
PDEPEND="
	...
	>=x11-libs/xcb-util-renderutil-0.3.8[${MULTILIB_USEDEP}]
