...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/motif/motif-2.2.3-r12.ebuild,v 1.13 2015/01/08 14:34:31 jlec Exp $
...
SRC_URI="
	ftp://ftp.ics.com/openmotif/2.2/${PV}/src/${MY_P}.tar.gz
...
RDEPEND="
	...
	abi_x86_32? ( !app-emulation/emul-linux-x86-motif[-abi_x86_32(-)] )
	"
