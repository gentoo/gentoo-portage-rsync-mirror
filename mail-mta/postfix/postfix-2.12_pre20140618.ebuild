...
# $Header: /var/cvsroot/gentoo-x86/mail-mta/postfix/postfix-2.12_pre20140618.ebuild,v 1.1 2014/06/19 14:06:03 eras Exp $
...
src_configure() {
	...
	emake makefiles shared=yes shlib_directory="/usr/$(get_libdir)" dynamicmaps=no \
