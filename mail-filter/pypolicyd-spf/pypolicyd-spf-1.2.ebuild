...
# $Header: /var/cvsroot/gentoo-x86/mail-filter/pypolicyd-spf/pypolicyd-spf-1.2.ebuild,v 1.1 2014/03/03 00:17:11 mjo Exp $

EAPI=5

# >= python-3.2 are also supported, but not until the pyspf ebuilds are
# updated.
...
#
DEPEND=">=dev-python/ipaddr-2.1.10[${PYTHON_USEDEP}]
