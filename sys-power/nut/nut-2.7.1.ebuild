...
# $Header: /var/cvsroot/gentoo-x86/sys-power/nut/nut-2.7.1.ebuild,v 1.1 2014/01/05 20:37:52 robbat2 Exp $
...
#for name in ${USB_DRIVERLIST} ; do
#	name="hald-addon-${name}"
#	IUSE_UPS_DRIVERS="${IUSE_UPS_DRIVERS} ups_drivers_${name}"
#	REQUIRED_USE="${REQUIRED_USE} ups_drivers_${name}? ( hal )"
#done
