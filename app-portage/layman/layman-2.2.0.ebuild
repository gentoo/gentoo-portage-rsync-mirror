...
# $Header: /var/cvsroot/gentoo-x86/app-portage/layman/layman-2.2.0.ebuild,v 1.2 2014/09/29 15:49:47 jer Exp $
...
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64 ~arm64 ~m68k ~mips ~s390 ~sh ~x86 ~ppc-aix ~x86-fbsd ~hppa-hpux ~ia64-hpux ~x86-interix ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
