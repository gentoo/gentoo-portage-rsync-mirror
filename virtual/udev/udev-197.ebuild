...
# $Header: /var/cvsroot/gentoo-x86/virtual/udev/udev-197.ebuild,v 1.4 2013/01/27 13:06:57 ssuominen Exp $
...
RDEPEND="|| ( >=sys-fs/udev-197-r3[gudev?,hwdb?,introspection?,keymap?,kmod?,selinux?,static-libs?]
	>=sys-fs/eudev-1_beta1[gudev?,hwdb?,introspection?,keymap?,kmod?,selinux?,static-libs?] )"
