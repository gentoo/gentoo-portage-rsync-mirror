...
# $Header: /var/cvsroot/gentoo-x86/net-libs/aqbanking/aqbanking-5.5.1.ebuild,v 1.1 2015/01/04 19:04:54 hanno Exp $
...
SRC_URI="http://www.aquamaniac.de/sites/download/download.php?package=03&release=118&file=01&dummy=${MY_P}.tar.gz -> ${MY_P}.tar.gz"
S="${WORKDIR}/${MY_P}"
