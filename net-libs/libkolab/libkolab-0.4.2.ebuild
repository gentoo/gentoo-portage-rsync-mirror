...
# $Header: /var/cvsroot/gentoo-x86/net-libs/libkolab/libkolab-0.4.2.ebuild,v 1.1 2013/09/15 12:52:29 johu Exp $
...
PATCHES=( "${FILESDIR}/${P}-cmake-2.8.11.patch" )
