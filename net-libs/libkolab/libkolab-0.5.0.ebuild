...
# $Header: /var/cvsroot/gentoo-x86/net-libs/libkolab/libkolab-0.5.0.ebuild,v 1.1 2014/02/21 18:01:56 kensington Exp $
...
src_prepare() {
	...
	sed -e "/add_subdirectory(utils)/d" -i CMakeLists.txt
