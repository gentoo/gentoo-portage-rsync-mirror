...
# $Header: /var/cvsroot/gentoo-x86/net-libs/serf/serf-1.3.2.ebuild,v 1.1 2013/10/17 23:25:13 floppym Exp $
...
LICENSE="Apache-2.0"
SLOT="1"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~mips ~ppc ~ppc64 ~sparc ~x86 ~x86-fbsd ~ppc-macos ~x64-macos"
IUSE="kerberos"
