...
# $Header: /var/cvsroot/gentoo-x86/net-libs/serf/serf-1.3.3.ebuild,v 1.1 2013/12/20 00:00:47 floppym Exp $
...
LICENSE="Apache-2.0"
SLOT="1"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~mips ~ppc ~ppc64 ~s390 ~sh ~sparc ~x86 ~x86-fbsd ~ppc-macos ~x64-macos"
IUSE="kerberos"
