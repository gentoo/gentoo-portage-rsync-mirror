...
# $Header: /var/cvsroot/gentoo-x86/net-libs/polarssl/polarssl-1.3.8.ebuild,v 1.4 2014/07/27 11:13:48 phajdan.jr Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${P}-ssl_pthread_server.patch
}
