...
# $Header: /var/cvsroot/gentoo-x86/net-news/quiterss/quiterss-0.12.5.ebuild,v 1.1 2013/04/26 09:51:25 pinkbyte Exp $

EAPI=5

PLOCALES="cs de el_GR en es fa fr hu it ja ko lt nl pl pt_BR ru sr sv uk zh_CN zh_TW"
inherit l10n qt4-r2
...
PATCHES=(
	"${FILESDIR}/${PN}-0.12.3-unbundle-sqlite.patch"
)
