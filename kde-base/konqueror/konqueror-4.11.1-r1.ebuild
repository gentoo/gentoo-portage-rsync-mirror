...
# $Header: /var/cvsroot/gentoo-x86/kde-base/konqueror/konqueror-4.11.1-r1.ebuild,v 1.1 2013/09/05 11:55:21 kensington Exp $
...
PATCHES=( "${FILESDIR}/${P}-bookmarks.patch" )
