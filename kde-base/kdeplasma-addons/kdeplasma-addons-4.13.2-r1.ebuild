...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdeplasma-addons/kdeplasma-addons-4.13.2-r1.ebuild,v 1.1 2014/06/26 15:31:45 kensington Exp $
...
PATCHES=( "${FILESDIR}/${P}-comics.patch" )
