...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdelibs/kdelibs-4.11.0-r1.ebuild,v 1.1 2013/08/25 15:05:56 kensington Exp $
...
mmx nls openexr +policykit spell sse sse2 ssl +udev +udisks +upower zeroconf"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-4.11.0-themecrash.patch"
)
