...
# $Header: /var/cvsroot/gentoo-x86/dev-vcs/tortoisehg/tortoisehg-2.10.1.ebuild,v 1.2 2013/12/06 08:20:17 polynomial-c Exp $
...
if [[ ${PV} != *9999* ]]; then
	...
	HG_DEPEND=">=dev-vcs/mercurial-2.7 <dev-vcs/mercurial-2.9"
else
	inherit mercurial
