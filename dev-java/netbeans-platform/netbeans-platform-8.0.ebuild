...
# $Header: /var/cvsroot/gentoo-x86/dev-java/netbeans-platform/netbeans-platform-8.0.ebuild,v 1.1 2014/03/23 18:59:08 fordfrog Exp $
...
src_prepare() {
	...
	java-pkg_jar-from --into libs.jna.platform/external jna platform.jar platform-3.4.0.jar
