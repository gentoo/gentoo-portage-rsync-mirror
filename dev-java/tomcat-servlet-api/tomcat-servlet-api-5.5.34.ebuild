...
# $Header: /var/cvsroot/gentoo-x86/dev-java/tomcat-servlet-api/tomcat-servlet-api-5.5.34.ebuild,v 1.2 2012/04/15 18:52:57 vapier Exp $
...
LICENSE="Apache-2.0"
SLOT="2.4"
KEYWORDS="~amd64 ~ia64 ~ppc ~x86 ~x86-fbsd ~x86-freebsd ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos"
IUSE="doc source"
