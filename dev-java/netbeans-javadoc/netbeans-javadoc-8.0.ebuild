...
# $Header: /var/cvsroot/gentoo-x86/dev-java/netbeans-javadoc/netbeans-javadoc-8.0.ebuild,v 1.1 2014/03/23 18:56:54 fordfrog Exp $
...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/51449E030F3A5F80327536CC51D75EE9D7E59BDA-ant-libs-1.9.2.zip"
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/51449E030F3A5F80327536CC51D75EE9D7E59BDA-ant-libs-1.9.2.zip o.apache.tools.ant.module/external/ant-libs-1.9.2.zip || die
	popd >/dev/null || die
}
