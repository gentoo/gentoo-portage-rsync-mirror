...
# $Header: /var/cvsroot/gentoo-x86/dev-java/netbeans-ide/netbeans-ide-8.0.ebuild,v 1.1 2014/03/23 18:56:14 fordfrog Exp $
...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/AD3C79D18E1ECBFC4118341CD9B24AF74C7F561D-glassfish-tooling-sdk-0.3-b054.jar
	...
	http://hg.netbeans.org/binaries/5DC6B9C3BA39C9E5B7A2E6E0B2DE20EA7204CD7F-js-corestubs.zip
	http://hg.netbeans.org/binaries/9E3B6351F64AFC8525D22DBB87C3A1AD8C7B6CE1-js-domstubs.zip
	http://hg.netbeans.org/binaries/A0509A52819E39899BD926A6C04B4AACA4358382-js-reststubs.zip
	...
	http://hg.netbeans.org/binaries/4B99546E8C8A04597B7A4564003E3B554EC12B5C-org.eclipse.jgit-3.2.0.201312181205-r.jar
	...
	http://hg.netbeans.org/binaries/04D9F4F0E7C3F9C18F72430FDFA06AD70D65CEEF-org.tmatesoft.svnkit_1.8.2.r10120_v20140102_1808.jar
	...
	http://hg.netbeans.org/binaries/FF906AF6FF5C987B760E30DD2B208F45377B6307-sqljet-1.1.9.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/AD3C79D18E1ECBFC4118341CD9B24AF74C7F561D-glassfish-tooling-sdk-0.3-b054.jar libs.glassfish.sdk/external/glassfish-tooling-sdk-0.3-b054.jar || die
	...
	ln -s "${DISTDIR}"/5DC6B9C3BA39C9E5B7A2E6E0B2DE20EA7204CD7F-js-corestubs.zip javascript2.editor/external/js-corestubs.zip || die
	ln -s "${DISTDIR}"/9E3B6351F64AFC8525D22DBB87C3A1AD8C7B6CE1-js-domstubs.zip javascript2.editor/external/js-domstubs.zip || die
	ln -s "${DISTDIR}"/A0509A52819E39899BD926A6C04B4AACA4358382-js-reststubs.zip javascript2.editor/external/js-reststubs.zip || die
	...
	ln -s "${DISTDIR}"/4B99546E8C8A04597B7A4564003E3B554EC12B5C-org.eclipse.jgit-3.2.0.201312181205-r.jar o.eclipse.jgit/external/org.eclipse.jgit-3.2.0.201312181205-r.jar || die
	...
	ln -s "${DISTDIR}"/04D9F4F0E7C3F9C18F72430FDFA06AD70D65CEEF-org.tmatesoft.svnkit_1.8.2.r10120_v20140102_1808.jar libs.svnClientAdapter.svnkit/external/org.tmatesoft.svnkit_1.8.2.r10120_v20140102_1808.jar || die
	...
	ln -s "${DISTDIR}"/FF906AF6FF5C987B760E30DD2B208F45377B6307-sqljet-1.1.9.jar libs.svnClientAdapter.svnkit/external/sqljet-1.1.9.jar || die
