...
# $Header: /var/cvsroot/gentoo-x86/dev-java/netbeans-enterprise/netbeans-enterprise-8.0.ebuild,v 1.1 2014/03/23 18:48:28 fordfrog Exp $
...
SRC_URI="${SOURCE_URL}
	...
	http://hg.netbeans.org/binaries/DD28F462C3E1BDCF49C0016B18B37CBAB56BE645-jsf-2.2.zip
	...
	http://hg.netbeans.org/binaries/9084CD23ACD33EA4EF4EADBCB8788A22AF361C07-primefaces-4.0.jar
...
src_unpack() {
	...
	ln -s "${DISTDIR}"/DD28F462C3E1BDCF49C0016B18B37CBAB56BE645-jsf-2.2.zip web.jsf20/external/jsf-2.2.zip || die
	...
	ln -s "${DISTDIR}"/9084CD23ACD33EA4EF4EADBCB8788A22AF361C07-primefaces-4.0.jar web.primefaces/external/primefaces-4.0.jar || die
