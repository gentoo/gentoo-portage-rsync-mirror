...
# $Header: /var/cvsroot/gentoo-x86/games-rpg/penumbra-collection/penumbra-collection-1.1.ebuild,v 1.6 2013/02/21 17:21:43 nimiux Exp $
...
RDEPEND="
	...
	x86? (
		...
		media-libs/freetype
		media-libs/libogg
		media-libs/libsdl[X,audio,video,opengl]
