...
# $Header: /var/cvsroot/gentoo-x86/dev-haskell/yesod-platform/yesod-platform-1.2.5.ebuild,v 1.1 2013/12/11 06:59:50 gienah Exp $
...
RDEPEND=">=dev-haskell/aeson-0.6.2.1:=[profile?]
	...
	>=dev-haskell/path-pieces-0.1.3:=[profile?]
	>=dev-haskell/pem-0.2.1:=[profile?]
	>=dev-haskell/persistent-1.2.3.0:=[profile?]
	>=dev-haskell/persistent-template-1.2.0.5:=[profile?]
	...
	>=dev-haskell/warp-2.0.0.1:=[profile?]
	...
	>=dev-haskell/yesod-routes-1.2.0.2:=[profile?]
