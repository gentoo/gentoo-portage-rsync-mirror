...
# $Header: /var/cvsroot/gentoo-x86/dev-haskell/conduit-extra/conduit-extra-1.1.6.1.ebuild,v 1.1 2015/01/04 12:57:02 gienah Exp $
...
PATCHES=("${FILESDIR}/${PN}-1.1.6.1-ghc-7.10.patch")
