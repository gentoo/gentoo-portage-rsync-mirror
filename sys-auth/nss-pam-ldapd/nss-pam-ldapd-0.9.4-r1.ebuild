...
# $Header: /var/cvsroot/gentoo-x86/sys-auth/nss-pam-ldapd/nss-pam-ldapd-0.9.4-r1.ebuild,v 1.1 2015/03/09 00:36:52 prometheanfire Exp $

EAPI=5

inherit eutils multilib multilib-minimal prefix user
