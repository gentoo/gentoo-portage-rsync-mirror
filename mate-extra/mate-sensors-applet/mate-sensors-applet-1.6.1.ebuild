...
# $Header: /var/cvsroot/gentoo-x86/mate-extra/mate-sensors-applet/mate-sensors-applet-1.6.1.ebuild,v 1.1 2014/03/10 00:50:48 tomwij Exp $
...
DEPEND="${RDEPEND}
	...
	>=app-text/scrollkeeper-0.3.14:0
	sys-devel/gettext:0
	virtual/pkgconfig:0"
