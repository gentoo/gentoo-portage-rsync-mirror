...
# $Header: /var/cvsroot/gentoo-x86/mate-extra/mate-screensaver/mate-screensaver-1.6.1.ebuild,v 1.1 2014/03/10 00:31:51 tomwij Exp $
...
src_prepare() {
	...
	sed -i 's:org.gnome:org.mate:' po/POTFILES.in || die

	# Make tests work.
	sed -i '6 a\data/lock-dialog-default.ui' po/POTFILES.in || die
