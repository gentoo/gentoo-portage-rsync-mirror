...
# $Header: /var/cvsroot/gentoo-x86/net-irc/hexchat/hexchat-2.9.4-r1.ebuild,v 1.1 2013/03/31 14:29:27 hasufell Exp $

EAPI=5

PYTHON_COMPAT=( python2_5 python2_6 python2_7 )
inherit autotools eutils gnome2-utils mono multilib flag-o-matic python-single-r1
...
IUSE="dbus fastscroll +gtk ipv6 libnotify libproxy nls ntlm perl +plugins plugin-checksum plugin-doat plugin-fishlim plugin-sysinfo python spell ssl theme-manager threads"
