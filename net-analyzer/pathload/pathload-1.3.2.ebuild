...
# $Header: /var/cvsroot/gentoo-x86/net-analyzer/pathload/pathload-1.3.2.ebuild,v 1.2 2014/07/16 16:08:33 jer Exp $
...
SRC_URI="http://www.cc.gatech.edu/fac/constantinos.dovrolis/bw-est/${PN}.tar.gz -> ${P}.tar.gz"
