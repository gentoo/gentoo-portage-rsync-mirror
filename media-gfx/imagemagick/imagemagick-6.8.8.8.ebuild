...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/imagemagick/imagemagick-6.8.8.8.ebuild,v 1.1 2014/03/19 16:59:21 ssuominen Exp $
...
LICENSE="imagemagick"
SLOT="0/${PV}"
KEYWORDS="~alpha ~amd64 ~arm ~hppa ~ia64 ~mips ~ppc ~ppc64 ~s390 ~sh ~sparc ~x86 ~amd64-fbsd ~x86-fbsd ~amd64-linux ~x86-linux ~ppc-aix ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-interix ~x86-solaris"
...
src_prepare() {
	epatch "${FILESDIR}"/${P}-openjpeg-2.0.0-has-no-opj_stream_destroy_v3.patch
