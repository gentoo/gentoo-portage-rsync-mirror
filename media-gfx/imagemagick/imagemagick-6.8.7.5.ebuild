...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/imagemagick/imagemagick-6.8.7.5.ebuild,v 1.1 2013/11/21 14:59:57 ssuominen Exp $
...
LICENSE="imagemagick"
SLOT="0/${PV}"
# KEYWORDS="~alpha ~hppa ~ia64 ~ppc64 ~sparc ~amd64-fbsd" dropped because of missing KEYWORDS in app-text/mupdf
KEYWORDS="~amd64 ~arm ~mips ~ppc ~s390 ~sh ~x86 ~ppc-aix ~x86-fbsd ~x86-interix ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
