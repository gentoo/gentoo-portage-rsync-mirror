...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/povray/povray-3.7.0_rc7.ebuild,v 1.4 2013/10/21 12:25:41 grobian Exp $
...
src_test() {
	...
	POVRAY_BETA=$(./unix/povray --betacode 2>&1) virtualmake
}
