...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/darktable/darktable-1.2-r1.ebuild,v 1.2 2013/06/13 12:28:27 xmw Exp $
...
src_install() {
	...
	use doc && dodoc "${DISTDIR}"/${PN}-usermanual-1.2.pdf
