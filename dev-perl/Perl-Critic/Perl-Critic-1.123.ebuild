...
# $Header: /var/cvsroot/gentoo-x86/dev-perl/Perl-Critic/Perl-Critic-1.123.ebuild,v 1.2 2015/06/13 18:53:52 dilfridge Exp $
...
DEPEND="${RDEPEND}
	>=virtual/perl-Module-Build-0.402.400
	test? (
		dev-perl/Test-Deep
		dev-perl/PadWalker
