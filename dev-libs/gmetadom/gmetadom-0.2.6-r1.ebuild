...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/gmetadom/gmetadom-0.2.6-r1.ebuild,v 1.1 2013/03/16 20:50:48 ottxor Exp $
...
PATCHES=( "${FILESDIR}"/${P}-gentoo-2.patch "${FILESDIR}"/${P}-gcc43.patch )
