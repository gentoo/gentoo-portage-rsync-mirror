...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/libisoburn/libisoburn-1.3.0.ebuild,v 1.3 2013/06/11 19:18:19 maekke Exp $
...
RDEPEND=">=dev-libs/libburn-1.3.0
	>=dev-libs/libisofs-1.3.0
