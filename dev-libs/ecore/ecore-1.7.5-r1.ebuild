...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/ecore/ecore-1.7.5-r1.ebuild,v 1.1 2013/04/02 08:59:48 tommy Exp $
...
RDEPEND=">=dev-libs/eina-1.7.0
	...
	evas? (
		...
		wayland? (
			>=media-libs/evas-1.7.5[directfb?,fbcon?,gles?,opengl?,wayland?,X?,xcb?]
		)
	)
