...
# $Header: /var/cvsroot/gentoo-x86/www-client/surf/surf-0.6-r1.ebuild,v 1.1 2013/09/12 15:01:44 jer Exp $
...
pkg_setup() {
	elog "net-misc/wget will be installed by default to"
