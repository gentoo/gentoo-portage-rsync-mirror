...
# $Header: /var/cvsroot/gentoo-x86/www-client/vivaldi/vivaldi-1.0.118.2_p1.ebuild,v 1.1 2015/03/04 13:47:21 jer Exp $
...
src_prepare() {
	...
	for d in 16 22 24 32 48 64 128 256; do
		...
		cp \
			opt/vivaldi-snapshot/product_logo_${d}.png \
