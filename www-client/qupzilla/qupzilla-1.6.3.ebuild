...
# $Header: /var/cvsroot/gentoo-x86/www-client/qupzilla/qupzilla-1.6.3.ebuild,v 1.1 2014/02/26 07:11:02 yngwin Exp $
...
SRC_URI="https://github.com/QupZilla/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	https://github.com/QupZilla/${PN}-plugins/archive/${PLUGINS_HASH}.tar.gz -> ${PN}-plugins-${PV}.tar.gz"
