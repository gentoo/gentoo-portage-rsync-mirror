...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/hardened-sources/hardened-sources-2.6.32-r145.ebuild,v 1.1 2013/01/07 18:12:35 blueness Exp $
...
HGPV="${KV_MAJOR}.${KV_MINOR}.${KV_PATCH}-149"
