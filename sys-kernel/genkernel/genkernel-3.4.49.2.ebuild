...
# $Header: /var/cvsroot/gentoo-x86/sys-kernel/genkernel/genkernel-3.4.49.2.ebuild,v 1.11 2014/11/26 09:37:54 armin76 Exp $
...
then
	...
	S="${WORKDIR}/${PN}"
	SRC_URI="${COMMON_URI}"
	KEYWORDS="alpha arm hppa ia64 s390 sh sparc"
else
