...
# $Header: /var/cvsroot/gentoo-x86/net-print/foomatic-db/foomatic-db-4.0.20130805.ebuild,v 1.1 2013/08/05 14:19:07 mrueg Exp $
...
src_install() {
	default
	rm "${ED}"/usr/share/foomatic/db/source/PPD
