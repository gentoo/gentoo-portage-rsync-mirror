...
# $Header: /var/cvsroot/gentoo-x86/net-misc/networkmanager/networkmanager-0.9.6.0.ebuild,v 1.7 2012/12/02 22:31:17 ssuominen Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${P}-cached-ipv6-routes-"{1,2}.patch
