...
# $Header: /var/cvsroot/gentoo-x86/net-misc/youtube-dl/youtube-dl-2014.02.17.ebuild,v 1.1 2014/02/17 14:21:40 jer Exp $
...
src_prepare() {
	if ! use offensive; then
		local xxx=(
			...
			spankwire thisav tube8 xhamster xnxx xtube xvideos youjizz youporn
		)
