...
# $Header: /var/cvsroot/gentoo-x86/net-misc/youtube-dl/youtube-dl-2013.10.30.ebuild,v 1.1 2013/10/30 15:42:28 jer Exp $
...
src_prepare() {
	if ! use offensive; then
		local xxx=(
			pornotube redtube spankwire thisav xhamster xnxx xvideos youjizz
			youporn
		)
