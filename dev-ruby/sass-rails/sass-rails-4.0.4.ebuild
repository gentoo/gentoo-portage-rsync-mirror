...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/sass-rails/sass-rails-4.0.4.ebuild,v 1.1 2014/10/30 06:56:47 graaff Exp $
...
ruby_add_rdepend ">=dev-ruby/sass-3.2.2:0
	...
	>=dev-ruby/sprockets-2.8 <=dev-ruby/sprockets-2.12"
