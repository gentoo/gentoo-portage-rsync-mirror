...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/sass-rails/sass-rails-4.0.3.ebuild,v 1.1 2014/04/26 13:48:50 graaff Exp $
...
ruby_add_rdepend ">=dev-ruby/sass-3.2.0:0
	=dev-ruby/railties-4*
	=dev-ruby/sprockets-rails-2*
	>=dev-ruby/sprockets-2.8 <=dev-ruby/sprockets-2.11.0"
