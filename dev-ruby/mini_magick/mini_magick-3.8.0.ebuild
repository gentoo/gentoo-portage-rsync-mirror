...
# $Header: /var/cvsroot/gentoo-x86/dev-ruby/mini_magick/mini_magick-3.8.0.ebuild,v 1.1 2014/07/29 06:28:38 graaff Exp $
...
all_ruby_prepare() {
	...
	sed -e '/identifies when gm exists/a pending "depends on graphicsmagick"' \
