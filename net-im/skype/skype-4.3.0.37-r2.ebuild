...
# $Header: /var/cvsroot/gentoo-x86/net-im/skype/skype-4.3.0.37-r2.ebuild,v 1.1 2014/11/10 22:39:17 axs Exp $
...
RDEPEND="
	...
	amd64? (
		...
		pulseaudio? ( || (
			...
			>=app-emulation/emul-linux-x86-soundlibs-${EMUL_X86_VER}[pulseaudio]
		) )
