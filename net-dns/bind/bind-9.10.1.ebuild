...
# $Header: /var/cvsroot/gentoo-x86/net-dns/bind/bind-9.10.1.ebuild,v 1.2 2014/09/30 19:33:16 jer Exp $
...
SLOT="0"
KEYWORDS="~amd64 ~arm ~hppa ~mips ~s390 ~sh ~x86 ~x86-fbsd ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~sparc64-solaris ~x64-solaris ~x86-solaris"
