...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/go/go-1.4.ebuild,v 1.1 2014/12/11 06:24:53 patrick Exp $
...
src_install()
{
	...
	# the bash completions appear to be gone from the release tarball
