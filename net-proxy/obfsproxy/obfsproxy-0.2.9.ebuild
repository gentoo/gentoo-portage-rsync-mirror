...
# $Header: /var/cvsroot/gentoo-x86/net-proxy/obfsproxy/obfsproxy-0.2.9.ebuild,v 1.1 2014/05/02 13:39:07 blueness Exp $
...
PATCHES=( "${FILESDIR}"/${P}-remove-argparse.patch )
