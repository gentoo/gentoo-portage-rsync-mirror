...
# $Header: /var/cvsroot/gentoo-x86/sci-physics/lammps/lammps-20150403.ebuild,v 1.1 2015/04/12 16:00:15 nicolasbock Exp $
...
src_compile() {
	# The build system does not rebuild the packages with -fPIC.
