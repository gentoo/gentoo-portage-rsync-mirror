...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/policycoreutils/policycoreutils-2.1.14-r5.ebuild,v 1.1 2014/01/12 21:01:41 swift Exp $
...
src_install() {
	...
	installation-extras() {
		...
		emake -C "${BUILD_DIR}" DESTDIR="${D}" SHLIBDIR="${D}$(get_libdir)/rc" install || return 1
	}
