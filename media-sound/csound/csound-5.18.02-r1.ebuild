...
# $Header: /var/cvsroot/gentoo-x86/media-sound/csound/csound-5.18.02-r1.ebuild,v 1.2 2012/09/15 06:18:14 radhermit Exp $
...
src_install() {
	...
	mv "${D}"/usr/bin/{extract,csound_extract} || die
}
