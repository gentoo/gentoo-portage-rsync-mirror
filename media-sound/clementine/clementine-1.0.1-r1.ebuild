...
# $Header: /var/cvsroot/gentoo-x86/media-sound/clementine/clementine-1.0.1-r1.ebuild,v 1.14 2014/07/24 11:52:54 ssuominen Exp $
...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="ayatana cdda +dbus ios ipod kde lastfm mms mtp projectm test +udisks wiimote"
IUSE+="${LANGS// / linguas_}"
