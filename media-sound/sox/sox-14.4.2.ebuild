...
# $Header: /var/cvsroot/gentoo-x86/media-sound/sox/sox-14.4.2.ebuild,v 1.4 2015/05/27 05:42:04 jer Exp $
...
LICENSE="LGPL-2.1"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~arm ~arm64 hppa ~mips ~ppc ppc64 ~x86 ~x86-fbsd ~x86-freebsd ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-solaris"
