...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/libsemanage/libsemanage-2.3-r1.ebuild,v 1.1 2014/06/01 12:21:16 swift Exp $
...
multilib_src_install() {
	installation() {
		emake \
			LIBDIR="${D}/${EPREFIX}/usr/$(get_libdir)" \
			SHLIBDIR="${D}/${EPREFIX}/usr/$(get_libdir)" \
			DESTDIR="${D}" "$@"
	}
