...
# $Header: /var/cvsroot/gentoo-x86/dev-python/google-apputils/google-apputils-0.4.2.ebuild,v 1.1 2015/05/20 10:45:57 vapier Exp $
...
RDEPEND=">=dev-python/python-dateutil-1.4[${PYTHON_USEDEP}]
