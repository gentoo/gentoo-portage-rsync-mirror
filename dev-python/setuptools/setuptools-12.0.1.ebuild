...
# $Header: /var/cvsroot/gentoo-x86/dev-python/setuptools/setuptools-12.0.1.ebuild,v 1.2 2015/01/18 03:21:03 patrick Exp $

EAPI="5"
PYTHON_COMPAT=( python{2_7,3_3,3_4} pypy pypy3 )

RESTRICT="test" # if tests never pass what's the point?
