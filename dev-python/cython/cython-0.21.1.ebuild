...
# $Header: /var/cvsroot/gentoo-x86/dev-python/cython/cython-0.21.1.ebuild,v 1.1 2014/10/18 18:25:55 radhermit Exp $
...
DEPEND="${RDEPEND}
	...
	test? ( dev-python/numpy[$(python_gen_usedep python{2_7,3_3,3_4})] )"
