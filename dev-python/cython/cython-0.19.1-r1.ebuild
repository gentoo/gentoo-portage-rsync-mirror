...
# $Header: /var/cvsroot/gentoo-x86/dev-python/cython/cython-0.19.1-r1.ebuild,v 1.13 2015/01/03 00:06:36 idella4 Exp $
...
DEPEND="${RDEPEND}
	...
	test? (
		$(python_gen_cond_dep '>=dev-python/numpy-1.6.1-r1[${PYTHON_USEDEP}]' 'python*')
	)"
