...
# $Header: /var/cvsroot/gentoo-x86/dev-python/cython/cython-0.18-r1.ebuild,v 1.2 2013/02/09 17:56:44 mgorny Exp $
...
RDEPEND="numpy? ( >=dev-python/numpy-1.6.1-r1[${PYTHON_USEDEP}] )"
DEPEND="${RDEPEND}
