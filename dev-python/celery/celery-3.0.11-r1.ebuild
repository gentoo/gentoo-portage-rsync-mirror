...
# $Header: /var/cvsroot/gentoo-x86/dev-python/celery/celery-3.0.11-r1.ebuild,v 1.3 2013/01/06 19:26:45 mgorny Exp $
...
src_prepare() {
	epatch "${FILESDIR}/${P}-require-python-dateutil-2.1.patch"
}
