...
# $Header: /var/cvsroot/gentoo-x86/dev-python/manuel/manuel-1.7.1.ebuild,v 1.5 2013/09/05 18:47:11 mgorny Exp $

EAPI=5
PYTHON_COMPAT=( python2_{6,7} python{3_2,3_3} pypy2_0 )
