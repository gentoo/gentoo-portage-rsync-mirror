...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/libvisual-plugins/libvisual-plugins-0.4.0-r2.ebuild,v 1.19 2013/01/01 14:43:38 ago Exp $
...
LICENSE="GPL-2"
SLOT="0.4"
KEYWORDS="~alpha amd64 hppa ~ia64 ~mips ppc ppc64 x86 ~amd64-fbsd ~x86-fbsd"
