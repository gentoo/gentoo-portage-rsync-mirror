...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/vdr-vdrrip/vdr-vdrrip-0.3.0-r5.ebuild,v 1.3 2007/04/28 16:38:44 swegener Exp $
...
src_unpack() {
	...
	then
		...
		epatch ${FILESDIR}/mencoderparam.diff
