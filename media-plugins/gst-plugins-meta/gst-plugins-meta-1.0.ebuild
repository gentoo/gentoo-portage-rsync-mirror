...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-meta/gst-plugins-meta-1.0.ebuild,v 1.1 2012/12/09 08:58:08 tetromino Exp $
...
IUSE="aac a52 alsa dts dv dvb dvd ffmpeg flac http lame libvisual mms mp3 mpeg ogg oss pulseaudio taglib theora v4l vcd vorbis vpx wavpack X"
...
RDEPEND="media-libs/gstreamer:1.0
	...
	mp3? ( media-libs/gst-plugins-ugly:1.0
	...
	vcd? (	media-plugins/gst-plugins-mplex:1.0
		media-plugins/gst-plugins-mpeg2dec:1.0 )
