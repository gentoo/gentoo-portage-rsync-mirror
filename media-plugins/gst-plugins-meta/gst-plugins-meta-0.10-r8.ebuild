...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-meta/gst-plugins-meta-0.10-r8.ebuild,v 1.10 2013/02/03 13:47:15 ago Exp $
...
LICENSE="metapackage"
SLOT="0.10"
KEYWORDS="amd64 ~arm ~hppa ~ia64 ~mips ppc ppc64 ~sh x86 ~amd64-fbsd ~x86-fbsd ~x86-freebsd ~amd64-linux ~x86-linux ~x64-macos ~x86-solaris"
