...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/gst-plugins-meta/gst-plugins-meta-0.10-r8.ebuild,v 1.2 2013/01/07 19:35:41 jer Exp $
...
LICENSE="metapackage"
SLOT="0.10"
KEYWORDS="~amd64 ~hppa ~mips ~sh ~x86 ~x86-fbsd ~x86-freebsd ~amd64-linux ~x86-linux ~x64-macos ~x86-solaris"
